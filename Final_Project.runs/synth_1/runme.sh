...
HD_PWD='C:/Users/Edidiong/DSD_LAB_UTSA/Final_Project/Final_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BallBeamTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BallBeamTop.tcl
