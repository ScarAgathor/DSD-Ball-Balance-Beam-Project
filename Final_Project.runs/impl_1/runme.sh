...
HD_PWD='C:/Users/Edidiong/DSD_LAB_UTSA/Final_Project/Final_Project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BallBeamTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BallBeamTop.tcl -notrace
